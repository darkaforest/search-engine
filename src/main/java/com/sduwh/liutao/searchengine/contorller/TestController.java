...
public class TestController {
    ...
    public SearchResultsOut testSearch() {
        ...
        s1.setTitle("希捷paragon ntfs for Mac|希捷paragon ntfs Mac版下载 V15.5.10 - PC6苹果网");
        ...
        s1.setSummary("希捷paragon ntfs Mac版是Mac平台上的一款专用于希捷硬盘的ntfs工具软件。希捷 paragon ntfs Mac版只能供希捷的硬盘使用，其他NTFS格式的 ...");
        ...
        list.add(s2);
        return new SearchResultsBuilder().build(list);
    }
